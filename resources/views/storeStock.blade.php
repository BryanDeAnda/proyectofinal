        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Productos en sucursal</h4>
              @if (session('success'))
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    @foreach ($storeStocks as $storeStock)
                        <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$storeStock->id}}</strong></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <form class="dropdown-item" action="{{ route('storestocks.destroy', $storeStock) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
