<x-app-layout>
      <head>
        ...
        <title>Agregar storeStock</title>
          ...
          <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <ul class="menu-inner py-1">
                <!-- Forms & Tables -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Agregar relacion</span></li>
                <!-- Forms -->
            ...
            <div class="layout-page">
              ...
              <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                  <h4 class="fw-bold py-3 mb-4">Agregar relación</h4>

                  <div class="row">
                    <div class="col-md-6">
                      <div class="card mb-4">
                        <h5 class="card-header">Ingresa la información de la relación</h5>
                        <form  action="/storestocks" method="POST" autocomplete="off" class="card-body">
                          @csrf
                          <div class="form-floating">
                            <select class="form-control" aria-describedby="floatingInputHelp" name="store_id" id="store_id">
                          ...
                          <div class="form-floating">
                          <select class="form-control" aria-describedby="floatingInputHelp" name="stock_id" id="stock_id">
